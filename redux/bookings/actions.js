...
const bookingActions = {
  ...
  APPROVE_BOOKING_REQUEST: "APPROVE_BOOKING_REQUEST",
  APPROVE_BOOKING_SUCCESS: "APPROVE_BOOKING_SUCCESS",
  APPROVE_BOOKING_FAILURE: "APPROVE_BOOKING_FAILURE",

  DECLINE_BOOKING_REQUEST: "DECLINE_BOOKING_REQUEST",
  ...
  approveBooking: (bookingId) => ({
    type: bookingActions.APPROVE_BOOKING_REQUEST,
    bookingId,
  }),
  declineBooking: (bookingId) => ({
    type: bookingActions.DECLINE_BOOKING_REQUEST,
    bookingId,
  }),
