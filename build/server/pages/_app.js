...
// CONCATENATED MODULE: ./redux/authentication/reducer.js
...
function authReducer(state = initState, action) {
  switch (action.type) {
    case authentication_actions["a" /* default */].LOGIN_REQUEST_SUCCESS:
      router_default.a.replace('/admin');
    ...
    case authentication_actions["a" /* default */].LOGOUT_REQUEST_SUCCESS:
      router_default.a.replace('/admin/signin');
      return initState;
...
// CONCATENATED MODULE: ./shared/library/helpers/isServer.js
const isServer = true;
...
function appReducer(state = reducer_initState, action) {
  switch (action.type) {
...
/* harmony default export */ var reducer = (function (state = themeSwitcher_reducer_initState, action) {
  switch (action.type) {
