                ...
                <Container>
                    ...
                    <Form
                        ...
                        <Row gutter={[32, 32]}>
                            ...
                            <Col lg={12} sm={24}>
                                <Form.Item label="How many adults, and how many children" name="people" {...textConfig}>
                                    <Input size="large"/>
                                </Form.Item>
                            </Col>
                            <Col lg={12} sm={24}>
                                <Form.Item label="Pets - if yes, please list type and breed"
                                           name="pets" {...textConfig}>
                                    <Input size="large"/>
                                </Form.Item>
                            </Col>
                            <Col lg={12} sm={24}>
                                <Form.Item label="Contact in case of an emergency" name="contact" {...textConfig}>
                                    <Input size="large"/>
                                </Form.Item>
                            </Col>
                            <Col lg={12} sm={24}>
                                <Form.Item label="Employer? (if student, please list name of university)"
                                           name="employer" {...textConfig}>
                                    <Input size="large"/>
                                </Form.Item>
                            </Col>
                            <Col lg={12} sm={24}>
                            ...
                            <Col lg={12} sm={24}>
                                <Form.Item label="Salary (Please state currency)" name="salary" {...textConfig}>
                                    <Input size="large"/>
                                </Form.Item>
                            </Col>
                            <Col lg={12} sm={24}>
                                <Form.Item label="Reason for your visit" name="reason" {...textConfig}>
                                    <Input size="large"/>
                                </Form.Item>
                            </Col>
                            <Col lg={12} sm={24}>
                                <Form.Item label="Anything else we should know of" name="extradetail" {...textConfig}>
                                    <Input size="large"/>
                                </Form.Item>
                            </Col>
                            <Col lg={24} sm={24}>
                            ...
                            <Col lg={8} sm={24}>
                                <Form.Item label="Complete Address" name="lordaddress" {...textConfig}>
                                    <AddressInput/>
                                </Form.Item>
                            </Col>
                            <Col lg={8} sm={24}>
                                <Form.Item label="Phone Number" name="lordphonenumber" {...textConfig}>
                                    <PhoneNumberInput/>
                                </Form.Item>
                            </Col>
                            <Col lg={24} sm={24}>
                            ...
                            <Col lg={8} sm={24}>
                                <Form.Item label="Complete Address" name="formerlordaddress" {...textConfig}>
                                    <AddressInput/>
                                </Form.Item>
                            </Col>
                            <Col lg={8} sm={24}>
                                <Form.Item label="Phone Number" name="formerlordphonenumber" {...textConfig}>
                                    <PhoneNumberInput/>
                                </Form.Item>
                            </Col>
