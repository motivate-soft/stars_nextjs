                ...
                <Row gutter={[32, 32]}>
                    ...
                    <Col lg={{order: 1, span: 12}} sm={{order: 2, span: 24}}>
                        <p>
                            ...
                            <Link href="/terms-and-conditions" target="_blank"><u>Terms & Conditions</u></Link>{' '}
                            and{' '}
                            <Link href="/privacy-policy" target="_blank"><u>Privacy Policy</u></Link>
                        </p>
                    </Col>
                    <Col lg={{order: 2, span: 12}} sm={{order: 1, span: 24}}>
                        <Button type="secondary" htmlType="submit" size="large">Agree and Continue</Button>
                        <p><Link href="/cancellation-policy" target="_blank"><u>View Cancellation Policy</u></Link>
                        </p>
                    </Col>
                </Row>
                <p>
                    <Link href="/contact" target="_blank"><u>Contact us</u></Link>{' '}
